...
const faqData = [
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          There are three primary scenarios describing how much water drains from the glacier-dammed
          lake during a Glacial Lake Outburst Flood (GLOF):
        </p>
        <ol>
          <li>
            <strong>Full Volume Release</strong>: All water in the lake drains in a single event,
            even if the lake wasn’t at full capacity beforehand.
          </li>
          <li>
            <strong>Full Basin Release</strong>: The lake was at full capacity (equal to the dam
            height) and then drained almost completely.
          </li>
          <li>
            <strong>Partial Basin Release</strong>: Only part of the water drains during the flood; a
            significant volume remains in the lake afterward.
          </li>
        </ol>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>
          Large outburst floods such as the August, 2024 event can raise the water level in
          Mendenhall Lake by 10 ft or more in the course of a few days (see graph below). During
          smaller GLOFs, such as the July 2015 event, the rise in the lake level can be much smaller
          (~2 ft).
        </p>
        <img
    ...
    <div className="home-container">
      ...
      <div className="home-intro">
        <div className="home-about-card">
          <h3>About</h3>
          <p>
            This dashboard was created and is maintained by the University of Alaska Southeast in
            partnership with the Alaska Climate Adaptation Science Center. The page provides an
            ...
            contracted by the City and Borough of Juneau for the Mendenhall Valley. It also contains
            information about glacial lake outburst floods (GLOFs) from Suicide Basin. Use the cards
            above to explore flood maps, flood forecasting, past outburst flood events, and
            understand how outburst floods originate from Suicide Basin and impact the Juneau area.
            This website is for planning purposes only. For the National Weather Service monitoring
            page click below.
          </p>
...
<div className="home-flood-card">
  ...
  <p>
        ...
        <div className="home-about-card">
          <h3>Contact Us</h3>
          <p>
            This dashboard is maintained by the University of Alaska Southeast. For questions or
