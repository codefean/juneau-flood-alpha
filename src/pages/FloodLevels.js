...
const FloodLevels = () => {
  ...
  const updateFloodLayers = (mode) => {
    ...
    const baseTilesets = {
      65: "3z7whbfp", 66: "8kk8etzn", 67: "akq41oym", 68: "5vsqqhd8", 69: "awu2n97c",
      70: "a2ttaa7t", 71: "0rlea0ym", 72: "44bl8opr", 73: "65em8or7", 74: "9qrkn8pk",
    };
    const hescoTilesets = {
    ...
    validLevels.forEach((level) => {
      ...
      const tilesetId = mode ? hescoTilesets[level] : baseTilesets[level];
      if (mode && !tilesetId) return loadedCount++;
